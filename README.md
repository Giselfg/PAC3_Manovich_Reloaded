...
> Un cop els ordinadors es van convertir en una llar còmoda per a un gran nombre de mitjans simulats i nous, és lògic esperar que comencin a crear híbrids. I això és exactament el que ha estat succeint en aquesta nova etapa de l'evolució dels mitjans. Tant els tipus de mitjans simulats com els nous (text, hipertext, fotografies fixes, vídeo digital, animació 2D, animació 3D, espais 3D navegables, mapes, informació d'ubicació i eines de programari social) van arribar a funcionar com a elements bàsics per a moltes combinacions de mitjans nous. - Lev Manovich
...
Comenta un treballador d'Epic Games.
...
Per últim, aquest motor també s’ha utilitzat en emissions en directe. Dos dels grups de música més famosos del món, Coldplay i BTS, van realitzar una magnífica actuació en directe de la seva cançó “My Universe”, en la qual els set membres de BTS apareixien com a hologrames sobre l’escenari en temps real.
...
Ara parlem de Megascans.

Quixel Megascans es tracta d’una extensa biblioteca en línia d’escaneig d’objectes, superfícies i vegetació, entre d’altres, en 2D i en 3D. Aquests es renderitzen amb PBR (Physically Based Rendering), el qual modela el comportament de la llum sobre un material per tal de fer-lo més realista.

Amb l’aplicació de texturització Quixel Mixer es poden combinar i modificar aquests materials, tant com pintar sobre models 3D com crear assets personalitzats.
...
> La nostra missió és escanejar el món i construir un ecosistema que desbloquegi art al nivell dels triple A per a tothom.

Cita Teddy Bergsmen, cofundador de Quixel. 

Per dur a terme tots aquests escanejos, els treballadors de Quixel van fer ús d'una tècnica anomenada "fotogrametria". Aquesta és una tècnica que té com a objectiu l'estudi i la definició precisa de la forma, les dimensions i la posició a l'espai d'un objecte, a través de les dades obtingudes d'una o diverses fotografies. Els mètodes que s'utilitzen per obtenir aquestes imatges és el següent:
* Fotografia d'objectes. Primerament, es prenen les fotografies, preferiblement de forma aèria.
* Processament de les imatges. Un cop aconseguides les imatges, s'han de processar.
* Orientació de les imatges. Els fotogrames s'han de col·locar en la posició adequada per reconstruir i formar el model. Es poden emprar dos sistemes: restitució i rectificació.
...
*  *Epic Games and Quixel join forces to empower creators* [en línia] [consulta: 11/05/2022]. Disponible a: https://www.unrealengine.com/en-US/blog/epic-games-and-quixel-join-forces-to-empower-creators
*  *Wikipedia - Physically based rendering* [en línia] [consulta: 11/05/2022]. Disponible a: https://en.wikipedia.org/wiki/Physically_based_rendering
*  *Wikipedia - Fotogrametría* [en línia] [consulta: 11/05/2022]. Disponible a: https://es.wikipedia.org/wiki/Fotogrametr%C3%ADa
